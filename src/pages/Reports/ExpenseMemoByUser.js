...
const ExpenseMemoByUser = (props) => {
     ...
     const loadMemos = async () => {
          let url = process.env.REACT_APP_BASEURL + "memos/getall_by_user";
...
export default withRouter(connect(null, {})(withNamespaces()(ExpenseMemoByUser)));
