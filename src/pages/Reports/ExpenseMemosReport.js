...
const ExpenseMemosReport = (props) => {
     ...
     const handleDownload = async () => {
          const fileName = "expense_memos_report";
               ...
               <div className="page-content">
                    <Container fluid={true}>
                         <Breadcrumbs
                              ...
                              breadcrumbItem={props.t("Daily Expense Report")}
                         />
                         <Row>
                              <Col lg={6}>
                                   <Card>
...
export default withRouter(
     connect(null, {})(withNamespaces()(ExpenseMemosReport))
);
